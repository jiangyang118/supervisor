-- NOTE: This migration converts master tables to BIGINT UNSIGNED auto-increment IDs
-- and associates them with school_id (BIGINT UNSIGNED NOT NULL). It also aligns
...
alter table food_waste_reasons
  modify column id bigint unsigned not null auto_increment,
  add column school_id bigint unsigned not null default 1 after id,
