...
const courses = ref([{ id: 'CRS-101', title: '后厨卫生规范', status: '进行中' }]);
const exams = ref([
  { id: 'EX-101', title: '卫生规范考试', strategy: '乱序+自动判卷', status: '未开始' },
]);
const results = ref([{ id: 'RES-101', user: '张三', score: 92, passed: '合格' }]);
const onExportCsv = () =>
