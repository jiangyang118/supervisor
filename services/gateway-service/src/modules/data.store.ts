    ...
    this.aiEvents = [
      {
        ...
        cameraId: '01',
        type: '未戴帽',
        detectedAt: new Date(Date.now() - 3600e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/nohat/120/80',
      },
      {
        id: 'E-002',
        schoolId: 'sch-001',
        cameraId: '02',
        type: '未戴口罩',
        detectedAt: new Date(Date.now() - 1800e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/nomask/120/80',
      },
      {
        id: 'E-003',
        schoolId: 'sch-001',
        cameraId: '03',
        type: '未穿工作服',
        detectedAt: new Date(Date.now() - 1200e3).toISOString(),
        status: 'ACK',
        snapshotUrl: 'https://picsum.photos/seed/nouniform/120/80',
      },
      {
        id: 'E-004',
        schoolId: 'sch-001',
        cameraId: '03',
        type: '未戴手套',
        detectedAt: new Date(Date.now() - 600e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/nogloves/120/80',
      },
      {
        id: 'E-005',
        schoolId: 'sch-001',
        cameraId: '01',
        type: '打电话',
        detectedAt: new Date(Date.now() - 300e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/phone/120/80',
      },
      {
        id: 'E-006',
        schoolId: 'sch-001',
        cameraId: '02',
        type: '吸烟',
        detectedAt: new Date(Date.now() - 240e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/smoke/120/80',
      },
      {
        id: 'E-007',
        schoolId: 'sch-001',
        cameraId: '04',
        type: '烟火',
        detectedAt: new Date(Date.now() - 180e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/fire/120/80',
      },
      {
        id: 'E-008',
        schoolId: 'sch-001',
        cameraId: '05',
        type: '鼠患',
        detectedAt: new Date(Date.now() - 120e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/rodent/120/80',
      },
      {
        id: 'E-009',
        schoolId: 'sch-002',
        cameraId: '01',
        type: '未戴帽',
        detectedAt: new Date(Date.now() - 90e3).toISOString(),
        status: 'OPEN',
        snapshotUrl: 'https://picsum.photos/seed/nohat2/120/80',
      },
    ];
